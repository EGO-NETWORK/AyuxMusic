...
from AyuXmusic.misc import _boot_
from AyuXmusic.plugins.sudo.sudoers import sudoers_list
from AyuXmusic.utils.database import (
    add_served_chat,
    add_served_user,
    blacklisted_chats,
    get_lang,
...
from AyuXmusic.utils.decorators.language import LanguageStart
from AyuXmusic.utils.formatters import get_readable_time
from AyuXmusic.utils.inline import help_pannel, private_panel, start_panel
from config import BANNED_USERS, LOGGER_ID
from strings import get_string
from AyuXmusic import LOGGER

START_STICKER_ID = "CAACAgUAAxkBAALEzmoLEhhf9fR0B3wbOrS7QtSvInpPAAK1IAACVi1RVAt0S_QFFYk4HgQ"


async def send_start_sticker(message: Message):
    sticker = await message.reply_sticker(START_STICKER_ID)
...
async def start_pm(client, message: Message, _):
    ...
    if len(message.text.split()) > 1:
        ...
        if name[0:4] == "help":
            ...
            await send_start_sticker(message)
