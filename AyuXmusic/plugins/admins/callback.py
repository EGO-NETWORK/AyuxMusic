...
from AyuXmusic import YouTube, app
from AyuXmusic.core.call import Siddu
from AyuXmusic.misc import SUDOERS, db
...
from AyuXmusic.utils.formatters import seconds_to_min
from AyuXmusic.utils.inline import close_markup, stream_markup, stream_markup_timer
from AyuXmusic.utils.stream.autoclear import auto_clean
from AyuXmusic.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
...
async def del_back_playlist(client, CallbackQuery:CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Siddu.pause_stream(chat_id)
        ...
        await Siddu.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
