...
/tagall [ᴍᴇssᴀɢᴇ] : ᴛᴀɢ ᴀʟʟ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀs ᴡɪᴛʜ ᴛʜᴇ ɢɪᴠᴇɴ ᴍᴇssᴀɢᴇ. ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ʀᴇᴘʟʏ /tagall ᴛᴏ ᴀɴʏ ᴍᴇssᴀɢᴇ.

/stop : sᴛᴏᴘ ᴛʜᴇ ʀᴜɴɴɪɴɢ ᴛᴀɢᴀʟʟ ᴘʀᴏᴄᴇss.

/utag : ᴛᴀɢ ᴇᴀᴄʜ ɢʀᴏᴜᴘ ᴍᴇᴍʙᴇʀ ᴡɪᴛʜ ᴀ ʀᴀɴᴅᴏᴍ ᴄᴜᴛᴇ ᴍᴇssᴀɢᴇ.

/ustop : sᴛᴏᴘ ᴛʜᴇ ʀᴜɴɴɪɴɢ ᴜᴛᴀɢ ᴘʀᴏᴄᴇss.
"""
